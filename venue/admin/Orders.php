  ...
  <div id="content">
    ...
    <table width="100%" border="1" bordercolor="#003300" >
      <tr>
        ...
        <td bgcolor="#4B692D" class="style10 style3"><strong>Venue Name</strong></td>
       ...
       <td bgcolor="#4B692D" class="style10 style3"><strong>Request</strong></td>
        ...
        <td bgcolor="#4B692D" class="style10 style3"><strong>update </strong></td>
        <td bgcolor="#4B692D" class="style10 style3"><strong>Details</strong></td>
      </tr>
      <?php
	  session_start();
...
?>
      <tr>
        ...
        <td class="style3"><div align="left" class="style9 style5"><strong><?php echo $Total;?></strong></div></td>
			...
			<td><a href='oedit.php?edit=<?php echo $u_id; ?>'>Update</a></td>
        <td class="style3"><a href="Detail.php?CustomerId=<?php echo $Id;?>">Details</a></td>
