...
mysql_select_db($database_shop, $shop);
$query_Recordset2 = sprintf("SELECT ItemId, ItemName, `Size`, Image, soft, Price, Discount, Total FROM item_master WHERE CategoryId = %s", GetSQLValueString($colname_Recordset2, "int"));
            ...
            <tr>
              ...
              <td><label>
                <input type="file" name="txtFile" id="txtFile" />
			     ...
			     <tr>
              <td>venue brochure :</td>
              <td><label>
                <input type="file" name="softFile" id="softFile" />
              </label></td>
            </tr>
        ...
        <td>&nbsp;
          <table width="100%" border="1" cellpadding="2" cellspacing="2" bordercolor="#003300">
            <tr>
              ...
              <td bgcolor="#669900"><span class="style12">Place Name</span></td>
              <td bgcolor="#669900"><span class="style12">Persons :</span></td>
              <td bgcolor="#669900"><span class="style12">Image</span></td>
			<td bgcolor="#669900"><span class="style12">Venue brochure </span></td>
              <td bgcolor="#669900"><span class="style12">Price</span></td>
              <td bgcolor="#669900"><span class="style12">Discount</span></td>
              <td bgcolor="#669900"><span class="style12">Requests</span></td>
            </tr>
            <?php do { ?>
              <tr>
				...
				<td><img src="../Products/<?php echo $row_Recordset2['soft']; ?>" height="125px" width="125px"/></td>
